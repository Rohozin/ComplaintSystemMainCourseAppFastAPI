...
#Создать скрипт для командной строки- создать админа.
#Команда выглядит: 1. export RYTHONPATH=./ 2.python commands/create_super_user.py -f Test -l Admin -e qdx@com -p 321321 -i GB29NWBK60161331926819 -pa 310592
@click.command()
